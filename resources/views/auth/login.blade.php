        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
             ...
             <div>
                ...
                <x-jet-input id="email" class="block w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                @if (Route::has('password.request'))
                    <a class="underline text-sm hover:text-cyan-300" href="{{ route('password.request') }}">
