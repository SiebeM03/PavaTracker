<div class="p-6 sm:px-20 border-b border-card-title-border">
    <div>
    ...
    <div class="mt-6 text-card-gray-400">
...
<div class="grid grid-cols-1 md:grid-cols-2">
    <div class="p-6 border-t border-card-title-border md:border-t-0">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-card-gray-200 leading-7 font-semibold"><a href="https://laravel.com/docs">Documentation</a>
            </div>
        </div>
        
        <div class="ml-12">
            <div class="mt-2 text-sm text-card-gray-400">
            ...
            <a href="https://laravel.com/docs">
                <div class="mt-3 flex items-center text-sm font-semibold text-cyan-400 hover:text-cyan-300 active:text-cyan-500 transition">
    ...
    <div class="p-6 border-t border-card-title-border md:border-t-0 md:border-l">
        <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-8 h-8 text-gray-400">
            ...
            <div class="ml-4 text-lg text-card-gray-200 leading-7 font-semibold"><a href="https://laracasts.com">Laracasts</a>
            </div>
        </div>
    ...
    <div class="p-6 border-t border-card-title-border">
        <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-8 h-8 text-gray-400">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="ml-4 text-lg text-card-gray-200 leading-7 font-semibold"><a href="https://tailwindcss.com/">Tailwind</a>
            </div>
        </div>
    ...
    <div class="p-6 border-t border-card-title-border md:border-l">
        <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-8 h-8 text-gray-400">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="ml-4 text-lg text-card-gray-200 leading-7 font-semibold">Authentication</div>
        </div>
